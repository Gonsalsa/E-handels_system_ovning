using E_handels_system_övning.Product_data;
using System.Xml;

namespace E_handels_system_övning
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Book {Name = "PotatoTech", Brand = "Potatis United", Price = 99.99, Author = "Robin Kamo"},
                new Clothing {Name = " Polo", Brand = "Temu", Price = 59.99, Size = "L"},
                new Electronics {Name = "Airfryer", Brand = "ACME INC", Price = 599.99, WarrantyYears = 3},
            };

            bool running = true;
            while (running)
            {
                Console.WriteLine("=== Sebbes Svartjobb och Vitvaror (Admin Panel)===");
